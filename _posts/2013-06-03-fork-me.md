...
Lets make it default to [my GitHub](https://github.com/antivapor) if I leave it blank, add some switches, and make it smarter. Now with smart coding you can be forgetful! Change `github.html` to 
{% highlight html %}{% raw %}
{% if {{page.github}} == NULL %}
